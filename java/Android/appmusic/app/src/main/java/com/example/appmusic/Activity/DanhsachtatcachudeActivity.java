...
public class DanhsachtatcachudeActivity extends AppCompatActivity {
    ...
    RecyclerView recyclerViewtatcachide;
    ...
    private void GetData() {
        ...
        callback.enqueue(new Callback<List<ChuDe>>() {
            ...
            public void onResponse(Call<List<ChuDe>> call, Response<List<ChuDe>> response) {
                ...
                recyclerViewtatcachide.setLayoutManager(new GridLayoutManager(DanhsachtatcachudeActivity.this,1));
                recyclerViewtatcachide.setAdapter((danhsachtatcachudeAdapter));
            }
    ...
    private void init() {
        recyclerViewtatcachide = findViewById(R.id.recyclerviewAllChude);
