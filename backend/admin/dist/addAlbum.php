                        ...
                        <div class="card mb-4">
                            ...
                            <form action="xulithemalbum.php" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" placeholder="Nhập tên Album" name="TenAlbum">
                                </div>
                                <div class="form-group">
                                    <label for="inputtencasi">Tên ca sĩ Album:</label>
                                  <input type="text" class="form-control" placeholder="Nhập tên ca sĩ" name="CaSiAlbum">
                                </div>
                                <br>
                                <div class="form-group">
                                    <label for="upimage">Ảnh ALbum</label><br>
                                    <input type="file" name="HinhAlbum" id="HinhAlbum">
                                </div>
