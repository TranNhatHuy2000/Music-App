                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                Table Song
                                <a href="addsong.php"  class="btn btn-info">Thêm Bài Hát</a>
                            </div>
                            ...
                            <div >
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <?php 
                                            $sqlSelect = "SELECT * FROM ((baihat INNER JOIN album ON baihat.idAlbum = album.idAlbum) INNER JOIN theloai ON baihat.idTheLoai = theloai.idTheLoai);";
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><img src="<?php echo $row["HinhBaiHat"]?>"class="img-fluid img-thumbnail img-responsive" style="width:auto; height:100px;"></td>
                                                <td>
